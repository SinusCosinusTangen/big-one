...
const LoginForm = () => {
    ...
    return (        
        <form onSubmit={() => console.log('submitted')}>
            <p className="mt-2">Username/Email</p>
            ...
            <button className="mt-6 block w-full h-10 px-3 py-2 bg-white border border-sky-500 rounded-md text-sky-500 text-sm shadow-sm 
                font-semibold hover:bg-sky-500 hover:text-white active:bg-sky-600 focus:ring focus:ring-sky-300"
                onClick={() => console.log('submitted')}>Sign In
            </button>
